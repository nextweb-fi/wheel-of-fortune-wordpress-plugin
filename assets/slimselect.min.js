            ...
            (n.prototype.getSelected = function () {
              for (
                ...
                if (n.hasOwnProperty("label")) {
                  ...
                  n.selected &&
                    (this.main.config.isMultiple ? t.push(n) : (e = n));
              }
        ...
        function (e, t, i) {
              ...
              (c.prototype.setData = function (e) {
                if (r.validateData(e)) {
                  ...
                  if (this.config.isAjax && i)
                    if (this.config.isMultiple)
                      for (var n = 0, a = i.reverse(); n < a.length; n++) {
                        var o = a[n];
                        t.unshift(o);
                      }
                    else {
              ...
              (c.prototype.open = function () {
                ...
                if (this.config.isEnabled && !this.data.contentOpen) {
                  ...
                  if (
                    ...
                    if (i) {
                      var s = i.id,
                        n = this.slim.list.querySelector(
                          '[data-id="' + s + '"]'
                        );
          ...
          function c(e) {
            ...
            (this.ajax = null),
              ...
              (this.windowScroll = o.debounce(function (e) {
                t.data.contentOpen &&
                  ("above" ===
                  o.putContent(
                    t.slim.content,
              ...
              (this.documentClick = function (e) {
                e.target &&
                  !o.hasClassInTree(e.target, t.config.id) &&
                  t.close();
              });
        ...
        function (e, t, i) {
          ...
          function n(e) {
            (this.id = ""),
              ...
              (this.placeholderText = "Choose pages"),
                ...
                if (
                  ...
                  i.classList.add(this.main.config.valueDelete),
                    ...
                    (i.onclick = function (e) {
                      ...
                      var t = !1;
                      if (
                        (o.main.beforeOnChange || (t = !0),
                        o.main.beforeOnChange)
                      ) {
                        for (
                      ...
                      if (e.hasOwnProperty("label")) {
                        ...
                        i.classList.add(c.main.config.optgroupLabel),
                          c.main.config.selectByGroup &&
                            ...
                            i.classList.add(
                              c.main.config.optgroupLabelSelectable
                            ),
                          (i.innerHTML = t.label),
                          n.appendChild(i);
                        var s = t.options;
                        if (s) {
                          ...
                          if (
                            ...
                            i.addEventListener("click", function (e) {
                              e.preventDefault(), e.stopPropagation();
                              for (
                                var t = 0, i = n.children;
                                t < i.length;
                                t++
                              ) {
                                var s = i[t];
                                -1 !==
                                  s.className.indexOf(r.main.config.option) &&
                                  s.click();
                              }
                            });
                          }
